...
- **[svg-path-animator](./skills/engineering/svg-path-animator/SKILL.md)** — Animate SVG paths: self-drawing strokes, shape morphing, and moving elements along a path.
- **[codebase-brain-dump](./skills/engineering/codebase-brain-dump/SKILL.md)** — Explore an unfamiliar codebase and produce a self-contained knowledge document another agent can use safely.
