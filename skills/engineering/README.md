...
- **[codebase-brain-dump](./codebase-brain-dump/SKILL.md)** — Explore an unfamiliar codebase end-to-end and produce a self-contained `codebase-analysis-docs/CODEBASE_KNOWLEDGE.md` brain dump another agent can use to build features, fix bugs, or refactor safely.
