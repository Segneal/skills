...
- **[frontend-arch-scaffold](./frontend-arch-scaffold/SKILL.md)** — Scaffold the canonical React + Vite folder layout (features/, components/ui/, lib/, pages/) with per-folder READMEs and an ESLint boundaries config.
